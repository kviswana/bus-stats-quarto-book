...
In the prior chapters, we have established the overall *mean* as the *best model* when we have no other *explanatory* variable, and the category mean as the *best model* when we have a categorical explanatory variable.
